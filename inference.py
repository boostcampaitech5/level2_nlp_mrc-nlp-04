...
def inference(model_args, data_args, training_args):
    ...
    logger.info("Training/evaluation parameters %s", training_args) # verbosity 설정 : Transformers logger의 정보로 사용합니다 (on main process only)
...
def run_sparse_retrieval(
    ...
    if data_args.use_faiss and retri != 'bm25':
